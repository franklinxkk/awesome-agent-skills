...
- **[AI Delivery Spec](https://github.com/franklinxkk/ai-delivery-spec)** - Product-side SDD: PRD+FRR+AC-YAML+WBS from prototypes. Works with Claude Code/Cursor/Codex. v4.9.7.
